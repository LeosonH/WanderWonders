...
Status: production art, Supabase deployment, Apple Maps/Auth, Google Auth configuration, App ID, and App Store/TestFlight records are complete. Internal-only build `1.0 (1)` is Ready to Test with 1 owner tester Invited; unlock-time acceptance and the mentor tester remain pending.
